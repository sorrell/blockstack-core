...
find_header() {
   ...
   for HEADER_DIR in "/usr/include" "/usr/local/include" "/usr/include/x86_64-linux-gnu" $2; do
...
find_library() {
   ...
   for LIBRARY_DIR in "/lib" "/usr/lib" "/usr/local/lib" "/usr/lib/x86_64-linux-gnu" "/lib/x86_64-linux-gnu/" $2; do
